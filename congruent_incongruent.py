...
if not os.path.exists(os.path.join(os.getcwd(), 'logs', 'standard_nonstandard')):
    os.makedirs(os.path.join(os.getcwd(), 'logs', 'standard_nonstandard'))
