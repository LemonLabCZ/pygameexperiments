...
class TrialType(Enum):
    native_aa= "native_a-a"
    nonnative_iy = "non-native_i-y"
    native_ie = "native_i-e"
...
def create_set_trials(set_number, participant_seed, cannot_start_with=None):
    ...
    set_stimulus_types = []
    set_block_numbers = []
    block_order = [TrialType.native_aa, TrialType.nonnative_iy,
                   TrialType.native_ie]
...
def settings_folder():
    return os.path.join(os.getcwd(), 'settings', 'neuro3_syllables')
